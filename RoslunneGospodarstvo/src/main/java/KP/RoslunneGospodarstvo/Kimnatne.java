...
//		getContentPane().add(l_fonVodaOputuvanna);
		...
		JButton b_putanna2 = new JButton("Що це ?");
		...
		radioB_putanna7_1.setForeground(Color.BLACK);
		...
		radioB_putanna7_2.setForeground(Color.BLACK);
		...
		radioB_putanna8_1.setForeground(Color.BLACK);
		...
		radioB_putanna8_2.setForeground(Color.BLACK);
